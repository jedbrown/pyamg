...
SWIGINTERN PyObject *_wrap_truncate_rows_csr__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  truncate_rows_csr< int,float,float >(arg1,arg2,(int const (*))arg3,arg4,arg5);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object3 && array3) {
      Py_DECREF(array3); 
...
SWIGINTERN PyObject *_wrap_truncate_rows_csr__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  truncate_rows_csr< int,double,double >(arg1,arg2,(int const (*))arg3,arg4,arg5);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object3 && array3) {
      Py_DECREF(array3); 
...
SWIGINTERN PyObject *_wrap_truncate_rows_csr__SWIG_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  truncate_rows_csr< int,npy_cfloat_wrapper,float >(arg1,arg2,(int const (*))arg3,arg4,arg5);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object3 && array3) {
      Py_DECREF(array3); 
...
SWIGINTERN PyObject *_wrap_truncate_rows_csr__SWIG_4(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  truncate_rows_csr< int,npy_cdouble_wrapper,double >(arg1,arg2,(int const (*))arg3,arg4,arg5);
  resultobj = SWIG_Py_Void();
  {
    if (is_new_object3 && array3) {
      Py_DECREF(array3); 
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'truncate_rows_csr'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    truncate_rows_csr< int,float,float >(int const,int const,int const [],int [],float [])\n"
    "    truncate_rows_csr< int,double,double >(int const,int const,int const [],int [],double [])\n"
    "    truncate_rows_csr< int,npy_cfloat_wrapper,float >(int const,int const,int const [],int [],npy_cfloat_wrapper [])\n"
    "    truncate_rows_csr< int,npy_cdouble_wrapper,double >(int const,int const,int const [],int [],npy_cdouble_wrapper [])\n");
  return 0;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"satisfy_constraints_helper", _wrap_satisfy_constraints_helper, METH_VARARGS, (char *)"\n"
		...
		"satisfy_constraints_helper(int const RowsPerBlock, int const ColsPerBlock, int const num_block_rows, int const NullDim, npy_cfloat_wrapper const [] x, npy_cfloat_wrapper const [] y, npy_cfloat_wrapper const [] z, int const [] Sp, int const [] Sj, npy_cfloat_wrapper [] Sx)\n"
		"satisfy_constraints_helper(int const RowsPerBlock, int const ColsPerBlock, int const num_block_rows, int const NullDim, npy_cdouble_wrapper const [] x, npy_cdouble_wrapper const [] y, npy_cdouble_wrapper const [] z, int const [] Sp, int const [] Sj, npy_cdouble_wrapper [] Sx)\n"
		""},
	 { (char *)"calc_BtB", _wrap_calc_BtB, METH_VARARGS, (char *)"\n"
		...
		"calc_BtB(int const NullDim, int const Nnodes, int const ColsPerBlock, npy_cfloat_wrapper const [] b, int const BsqCols, npy_cfloat_wrapper [] x, int const [] Sp, int const [] Sj)\n"
		"calc_BtB(int const NullDim, int const Nnodes, int const ColsPerBlock, npy_cdouble_wrapper const [] b, int const BsqCols, npy_cdouble_wrapper [] x, int const [] Sp, int const [] Sj)\n"
		""},
	 { (char *)"incomplete_mat_mult_bsr", _wrap_incomplete_mat_mult_bsr, METH_VARARGS, (char *)"\n"
		...
		"incomplete_mat_mult_bsr(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, int const [] Bp, int const [] Bj, npy_cfloat_wrapper const [] Bx, int const [] Sp, int const [] Sj, npy_cfloat_wrapper [] Sx, int const n_brow, int const n_bcol, int const brow_A, int const bcol_A, int const bcol_B)\n"
		"incomplete_mat_mult_bsr(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, int const [] Bp, int const [] Bj, npy_cdouble_wrapper const [] Bx, int const [] Sp, int const [] Sj, npy_cdouble_wrapper [] Sx, int const n_brow, int const n_bcol, int const brow_A, int const bcol_A, int const bcol_B)\n"
		""},
	 { (char *)"truncate_rows_csr", _wrap_truncate_rows_csr, METH_VARARGS, (char *)"\n"
		"truncate_rows_csr(int const n_row, int const k, int const [] Ap, int [] Aj, float [] Ax)\n"
		"truncate_rows_csr(int const n_row, int const k, int const [] Ap, int [] Aj, double [] Ax)\n"
		"truncate_rows_csr(int const n_row, int const k, int const [] Ap, int [] Aj, npy_cfloat_wrapper [] Ax)\n"
		"truncate_rows_csr(int const n_row, int const k, int const [] Ap, int [] Aj, npy_cdouble_wrapper [] Ax)\n"
		""},
	 ...
	 { (char *)"classical_strength_of_connection", _wrap_classical_strength_of_connection, METH_VARARGS, (char *)"\n"
		...
		"classical_strength_of_connection(int const n_row, float const theta, int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, int [] Sp, int [] Sj, npy_cfloat_wrapper [] Sx)\n"
		"classical_strength_of_connection(int const n_row, double const theta, int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, int [] Sp, int [] Sj, npy_cdouble_wrapper [] Sx)\n"
		""},
	 { (char *)"symmetric_strength_of_connection", _wrap_symmetric_strength_of_connection, METH_VARARGS, (char *)"\n"
		...
		"symmetric_strength_of_connection(int const n_row, float const theta, int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, int [] Sp, int [] Sj, npy_cfloat_wrapper [] Sx)\n"
		"symmetric_strength_of_connection(int const n_row, double const theta, int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, int [] Sp, int [] Sj, npy_cdouble_wrapper [] Sx)\n"
		""},
	 { (char *)"evolution_strength_helper", _wrap_evolution_strength_helper, METH_VARARGS, (char *)"\n"
		...
		"evolution_strength_helper(npy_cfloat_wrapper [] Sx, int const [] Sp, int const [] Sj, int const nrows, npy_cfloat_wrapper const [] x, npy_cfloat_wrapper const [] y, npy_cfloat_wrapper const [] b, int const BDBCols, int const NullDim, float const tol)\n"
		"evolution_strength_helper(npy_cdouble_wrapper [] Sx, int const [] Sp, int const [] Sj, int const nrows, npy_cdouble_wrapper const [] x, npy_cdouble_wrapper const [] y, npy_cdouble_wrapper const [] b, int const BDBCols, int const NullDim, double const tol)\n"
		""},
	 { (char *)"incomplete_mat_mult_csr", _wrap_incomplete_mat_mult_csr, METH_VARARGS, (char *)"\n"
		...
		"incomplete_mat_mult_csr(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, int const [] Bp, int const [] Bj, npy_cfloat_wrapper const [] Bx, int const [] Sp, int const [] Sj, npy_cfloat_wrapper [] Sx, int const num_rows)\n"
		"incomplete_mat_mult_csr(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, int const [] Bp, int const [] Bj, npy_cdouble_wrapper const [] Bx, int const [] Sp, int const [] Sj, npy_cdouble_wrapper [] Sx, int const num_rows)\n"
		""},
	 ...
	 { (char *)"bsr_gauss_seidel", _wrap_bsr_gauss_seidel, METH_VARARGS, (char *)"\n"
		...
		"bsr_gauss_seidel(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, int const row_start, int const row_stop, int const row_step, int const blocksize)\n"
		"bsr_gauss_seidel(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, int const row_start, int const row_stop, int const row_step, int const blocksize)\n"
		""},
	 { (char *)"bsr_jacobi", _wrap_bsr_jacobi, METH_VARARGS, (char *)"\n"
		...
		"bsr_jacobi(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, npy_cfloat_wrapper [] temp, int const row_start, int const row_stop, int const row_step, int const blocksize, npy_cfloat_wrapper const [] omega)\n"
		"bsr_jacobi(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, npy_cdouble_wrapper [] temp, int const row_start, int const row_stop, int const row_step, int const blocksize, npy_cdouble_wrapper const [] omega)\n"
		""},
	 { (char *)"gauss_seidel", _wrap_gauss_seidel, METH_VARARGS, (char *)"\n"
		...
		"gauss_seidel(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, int const row_start, int const row_stop, int const row_step)\n"
		"gauss_seidel(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, int const row_start, int const row_stop, int const row_step)\n"
		""},
	 { (char *)"jacobi", _wrap_jacobi, METH_VARARGS, (char *)"\n"
		...
		"jacobi(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, npy_cfloat_wrapper [] temp, int const row_start, int const row_stop, int const row_step, npy_cfloat_wrapper const [] omega)\n"
		"jacobi(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, npy_cdouble_wrapper [] temp, int const row_start, int const row_stop, int const row_step, npy_cdouble_wrapper const [] omega)\n"
		""},
	 { (char *)"block_jacobi", _wrap_block_jacobi, METH_VARARGS, (char *)"\n"
		...
		"block_jacobi(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, npy_cfloat_wrapper const [] Tx, npy_cfloat_wrapper [] temp, int const row_start, int const row_stop, int const row_step, npy_cfloat_wrapper const [] omega, int const blocksize)\n"
		"block_jacobi(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, npy_cdouble_wrapper const [] Tx, npy_cdouble_wrapper [] temp, int const row_start, int const row_stop, int const row_step, npy_cdouble_wrapper const [] omega, int const blocksize)\n"
		""},
	 { (char *)"block_gauss_seidel", _wrap_block_gauss_seidel, METH_VARARGS, (char *)"\n"
		...
		"block_gauss_seidel(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, npy_cfloat_wrapper const [] Tx, int const row_start, int const row_stop, int const row_step, int const blocksize)\n"
		"block_gauss_seidel(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, npy_cdouble_wrapper const [] Tx, int const row_start, int const row_stop, int const row_step, int const blocksize)\n"
		""},
	 { (char *)"gauss_seidel_indexed", _wrap_gauss_seidel_indexed, METH_VARARGS, (char *)"\n"
		...
		"gauss_seidel_indexed(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, int const [] Id, int const row_start, int const row_stop, int const row_step)\n"
		"gauss_seidel_indexed(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, int const [] Id, int const row_start, int const row_stop, int const row_step)\n"
		""},
	 { (char *)"jacobi_ne", _wrap_jacobi_ne, METH_VARARGS, (char *)"\n"
		...
		"jacobi_ne(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, npy_cfloat_wrapper const [] Tx, npy_cfloat_wrapper [] temp, int const row_start, int const row_stop, int const row_step, npy_cfloat_wrapper const [] omega)\n"
		"jacobi_ne(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, npy_cdouble_wrapper const [] Tx, npy_cdouble_wrapper [] temp, int const row_start, int const row_stop, int const row_step, npy_cdouble_wrapper const [] omega)\n"
		""},
	 { (char *)"gauss_seidel_ne", _wrap_gauss_seidel_ne, METH_VARARGS, (char *)"\n"
		...
		"gauss_seidel_ne(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, int const row_start, int const row_stop, int const row_step, npy_cfloat_wrapper const [] Tx, float const omega)\n"
		"gauss_seidel_ne(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, int const row_start, int const row_stop, int const row_step, npy_cdouble_wrapper const [] Tx, double const omega)\n"
		""},
	 { (char *)"gauss_seidel_nr", _wrap_gauss_seidel_nr, METH_VARARGS, (char *)"\n"
		...
		"gauss_seidel_nr(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper [] z, int const col_start, int const col_stop, int const col_step, npy_cfloat_wrapper const [] Tx, float const omega)\n"
		"gauss_seidel_nr(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper [] z, int const col_start, int const col_stop, int const col_step, npy_cdouble_wrapper const [] Tx, double const omega)\n"
		""},
	 { (char *)"overlapping_schwarz_csr", _wrap_overlapping_schwarz_csr, METH_VARARGS, (char *)"\n"
		...
		"overlapping_schwarz_csr(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] x, npy_cfloat_wrapper const [] b, npy_cfloat_wrapper const [] Tx, int const [] Tp, int const [] Sj, int const [] Sp, int nsdomains, int nrows, int row_start, int row_stop, int row_step)\n"
		"overlapping_schwarz_csr(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] x, npy_cdouble_wrapper const [] b, npy_cdouble_wrapper const [] Tx, int const [] Tp, int const [] Sj, int const [] Sp, int nsdomains, int nrows, int row_start, int row_stop, int row_step)\n"
		""},
	 { (char *)"extract_subblocks", _wrap_extract_subblocks, METH_VARARGS, (char *)"\n"
		...
		"extract_subblocks(int const [] Ap, int const [] Aj, npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] Tx, int const [] Tp, int const [] Sj, int const [] Sp, int const nsdomains, int const nrows)\n"
		"extract_subblocks(int const [] Ap, int const [] Aj, npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] Tx, int const [] Tp, int const [] Sj, int const [] Sp, int const nsdomains, int const nrows)\n"
		""},
	 { (char *)"apply_householders", _wrap_apply_householders, METH_VARARGS, (char *)"\n"
		...
		"apply_householders(npy_cfloat_wrapper [] z, npy_cfloat_wrapper const [] B, int const n, int const start, int const stop, int const step)\n"
		"apply_householders(npy_cdouble_wrapper [] z, npy_cdouble_wrapper const [] B, int const n, int const start, int const stop, int const step)\n"
		""},
	 { (char *)"householder_hornerscheme", _wrap_householder_hornerscheme, METH_VARARGS, (char *)"\n"
		...
		"householder_hornerscheme(npy_cfloat_wrapper [] z, npy_cfloat_wrapper const [] B, npy_cfloat_wrapper const [] y, int const n, int const start, int const stop, int const step)\n"
		"householder_hornerscheme(npy_cdouble_wrapper [] z, npy_cdouble_wrapper const [] B, npy_cdouble_wrapper const [] y, int const n, int const start, int const stop, int const step)\n"
		""},
	 ...
	 { (char *)"bellman_ford", _wrap_bellman_ford, METH_VARARGS, (char *)"\n"
		"bellman_ford(int const num_rows, int const [] Ap, int const [] Aj, int const [] Ax, int [] x, int [] y)\n"
		"bellman_ford(int const num_rows, int const [] Ap, int const [] Aj, float const [] Ax, float [] x, int [] y)\n"
		"bellman_ford(int const num_rows, int const [] Ap, int const [] Aj, double const [] Ax, double [] x, int [] y)\n"
		""},
	 { (char *)"lloyd_cluster", _wrap_lloyd_cluster, METH_VARARGS, (char *)"\n"
		"lloyd_cluster(int const num_rows, int const [] Ap, int const [] Aj, int const [] Ax, int const num_seeds, int [] x, int [] y, int [] z)\n"
		"lloyd_cluster(int const num_rows, int const [] Ap, int const [] Aj, float const [] Ax, int const num_seeds, float [] x, int [] y, int [] z)\n"
		"lloyd_cluster(int const num_rows, int const [] Ap, int const [] Aj, double const [] Ax, int const num_seeds, double [] x, int [] y, int [] z)\n"
		""},
	 { (char *)"fit_candidates", _wrap_fit_candidates, METH_VARARGS, (char *)"\n"
		...
		"fit_candidates(int const n_row, int const n_col, int const K1, int const K2, int const [] Ap, int const [] Ai, npy_cfloat_wrapper [] Ax, npy_cfloat_wrapper const [] B, npy_cfloat_wrapper [] R, float const tol)\n"
		"fit_candidates(int const n_row, int const n_col, int const K1, int const K2, int const [] Ap, int const [] Ai, npy_cdouble_wrapper [] Ax, npy_cdouble_wrapper const [] B, npy_cdouble_wrapper [] R, double const tol)\n"
		""},
	 { NULL, NULL, 0, NULL }
};

...
def maximal_independent_set_parallel(num_rows, Ap, Aj, active, C, F, x, y, max_iters=-1):
    """
...
def maximal_independent_set_k_parallel(num_rows, Ap, Aj, k, x, y, max_iters=-1):
    """
...
def vertex_coloring_jones_plassmann(num_rows, Ap, Aj, x, y):
    """vertex_coloring_jones_plassmann(int const num_rows, int const [] Ap, int const [] Aj, int [] x, double [] y) -> int"""
    return _amg_core.vertex_coloring_jones_plassmann(num_rows, Ap, Aj, x, y)

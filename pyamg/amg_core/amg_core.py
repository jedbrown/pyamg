...
def conjugate(*args) -> "npy_cdouble_wrapper" :
  """
...
def zero_real(*args) -> "npy_cdouble_wrapper" :
  """
...
def zero_imag(*args) -> "npy_cdouble_wrapper" :
  """
...
def cljp_naive_splitting(*args) -> "void" :
  """
...
def rs_direct_interpolation_pass1(*args) -> "void" :
...
def maximal_independent_set_serial(*args) -> "int" :
  """
...
def maximal_independent_set_parallel(*args) -> "int" :
  """
...
def maximal_independent_set_k_parallel(*args) -> "void" :
  """
...
def vertex_coloring_LDF(*args) -> "int" :
...
def breadth_first_search(*args) -> "void" :
...
def connected_components(*args) -> "int" :
